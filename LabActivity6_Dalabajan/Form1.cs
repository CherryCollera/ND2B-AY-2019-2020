...
namespace LabActivity6_Dalabajan
{
    public partial class Form1 : Form
    {
        ...
        private void bSITToolStripButton_Click_1(object sender, EventArgs e)
        {
            try
            {
                this.tblStudent_InfoTableAdapter.BSIT(this.studentsDataSet.tblStudent_Info);
        ...
        private void address_BalangaToolStripButton_Click_1(object sender, EventArgs e)
        {
            try
            {
                this.tblStudent_InfoTableAdapter.Address_Balanga(this.studentsDataSet.tblStudent_Info);
        ...
        private void _2nd_YearToolStripButton_Click_1(object sender, EventArgs e)
        {
            try
            {
                this.tblStudent_InfoTableAdapter._2nd_Year(this.studentsDataSet.tblStudent_Info);
